...
class JsBinScriptUrlSpec extends Specification {
  "JS Bin JavaScript src URL extractor" should {
    "extract the HTTP JavaScript src URL from a realistic example" in {
      val binEditorHtml =
          """<!DOCTYPE html>
    ...
    "extract the HTTPS JavaScript src URL from a realistic example" in {
      val binEditorHtml =
        """<!DOCTYPE html>
          |<html id="jsbin" lang="en" class="">
          |<head>
          |  <meta charset=utf-8>
          |  <title>JS Bin - Collaborative JavaScript Debugging</title>
          |  <link rel="alternate" type="application/json+oembed" href="https://jsbin.com/oembed?url=https://jsbin.com/vujito/edit?html,output">
          |  <link rel="icon" href="https://static.jsbin.com/images/favicon.png">
          |  <link rel="stylesheet" href="https://static.jsbin.com/css/style.css?3.35.2">
          |
          |  <link rel="stylesheet" href="https://static.jsbin.com/css/font.css?3.35.2">
          |  <meta http-equiv="X-UA-Compatible" content="IE=edge">
          |
          |
          |  <!--[if lte IE 9 ]><link rel="stylesheet" href="https://static.jsbin.com/css/ie.css?3.35.2"><![endif]-->
          |    <script>
          |    (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
          |    (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
          |    m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
          ...
          |      <div class="toppanel-actions toppanel-actions-alone">
          |        <div>
          |          <a id="createnew" href="https://jsbin.com" class="toppanel-button">New bin</a>
          |        </div>
          |        <div>
          |        </div>
          |      </div>
          ...
          |    <div class="buttons">
          |        <div class="menu">
          |          <a href="https://jsbin.com/vujito/edit#file" target="_blank" class="brand button button-dropdown group button-dropdown-arrow"><img src="https://static.jsbin.com/images/favicon.svg"> File</a>
          |          <div class="dropdown" id="file">
          |            <div class="dropdownmenu">
          ...
          |              <a class="archivebin button group" data-desc="Archive bin" title="Archive this bin" href="/vujito/archive" data-shortcut="ctrl+y">Archive</a>
          |              <a class="unarchivebin button group" data-desc="Unrchive bin" title="Restore this bin from the archive" href="/vujito/unarchive" data-shortcut="ctrl+y">Unarchive</a>
          |              <hr data-desc="">
          |              <a id="addmeta" data-desc="Insert a description shown in My Bins" title="Add meta data to bin" class="button group" href="#add-description">Add description</a>
          ...
          |                <div class="result">
          |                  <div data-desc="This bin's full output without the JS Bin editor">
          |                    <strong><a class="link" data-path="/" target="_blank" href="https://jsbin.com/vujito">Link</a></strong><br>
          |                    <input name="url" class="link" value="https://jsbin.com/vujito/edit" type="text">
          |                  </div>
          |                  <div data-desc="Direct links to specific sources of the bin">
          |                    <span class="direct-links"></span>
          |                  </div>
          |                  <div data-desc="Embed this bin with the live output on your site">
          |                    <span class="heading">Embed</span><br><textarea id="embedfield" name="embed" data-path="/embed" class="link">&lt;a class=&quot;jsbin-embed&quot; href=&quot;https://jsbin.com/vujito/embed?live&quot;&gt;JS Bin demo&lt;/a&gt;&lt;script src=&quot;https://static.jsbin.com/js/embed.js&quot;&gt;&lt;/script&gt;</textarea>
          |                  </div>
          |                  <div data-desc="The preview of JS Bin when you share your bin">
          |                    <span class="heading">What they'll see</span><br>
          |                    <div id="share-preview">
          ...
          |        </div>
          |        <div id="start-saving" class="menu">
          |          <a href="/vujito/save" class="save button group">Start saving your work</a>
          |        </div>
          |      <div id="panels"></div>
          |      <div class="help">
          |          <div class="loggedout menu">
          ...
          |  <div class="dropdown dd-right" id="profile">
          |    <div class="dropdowncontent">
          |      <div class="large-gravatar"><object data="https://static.jsbin.com/images/default-avatar.min.svg?{name}&3.35.2" type="image/svg+xml">
          |    <img src="https://static.jsbin.com/images/default-avatar.min.svg?3.35.2"></object><picture class="large-gravatar">
          |    <source srcset="{large_avatar} 1x, {large_avatar}?&s=240 2x">
          |    <img class="large-gravatar" src="{large_avatar}">
          |  </picture></div>
          |      <span class="input" id="username" readonly>
          ...
          |Include alerts, prompts &amp; confirm boxes">Run with JS</button>
          |          <label>Auto-run JS<input type="checkbox" id="enablejs"></label>
          |          <a target="_blank" title="Live preview" id="jsbinurl" class="" href="/vujito"><img src="https://static.jsbin.com/images/popout.png"></a>
          |        </span>
          |        <span class="size"></span>
          |      </div>
          |    </div>
          |  </div>
          |  <form id="saveform" method="post" action="/vujito/save">
          |    <input type="hidden" name="method">
          |    <input type="hidden" name="_csrf" value="7DsEMIx2gcDR8lO0rz/D1Ke1">
          |  </form>
          |</div>
          |<div id="tip" class=" notification">
          |  <p>
          ...
          |<script src="https://jsbin.com/bin/user.js?6def"></script>
          |<script src="https://static.jsbin.com/js/prod/jsbin-3.35.2.min.js"></script>
          |<script src="https://jsbin.com/bin/start.js?6aad"></script>
          |</body>
          |</html>
          |
          |""".stripMargin

      val expectedScriptUrl = Uri("https://jsbin.com/bin/start.js?6aad")
      val scriptUrlOption = binEditorHtml match {
        case JsBinScriptUrl(scriptUrl) => Some(scriptUrl)
        case _ => None
      }
