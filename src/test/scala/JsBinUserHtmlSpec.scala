...
class JsBinUserHtmlSpec extends Specification {
  "JS Bin user HTML extractor" should {
    "successfully and correctly extract the user-level embedded HTML from a realistic example" in {
      ...
      val binPage =
          """<!DOCTYPE html>
            ...
            |  <link rel="stylesheet" href="http://static.jsbin.com/css/flat-ui.css?3.19.1">
            |  <meta http-equiv="X-UA-Compatible" content="IE=edge">
            |
            |  <!--[if lte IE 9 ]><link rel="stylesheet" href="http://static.jsbin.com/css/ie.css"><![endif]-->
            |</head>
            ...
            |
            |
            |<script src="http://static.jsbin.com/js/prod/jsbin-3.19.1.min.js"></script>
            |<script>
            ...
            |
            |""".stripMargin
      val userHtmlOption = binPage match {
        case JsBinUserHtml(binUserHtml) => Some(binUserHtml)
        case _ => None
      }
